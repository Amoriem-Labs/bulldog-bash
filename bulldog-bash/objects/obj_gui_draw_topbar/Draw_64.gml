...
h_offset = 95;
v_offset = 92;
topbar_spr_width = sprite_get_width(health_right);
topbar_spr_height = sprite_get_height(health_right);

draw_sprite(ui_top, 0, h_centre, 0);

masked = surface_create( topbar_spr_width, topbar_spr_height );

surface_set_target( masked );
draw_sprite( health_left, 0, 0, 0 );
...
surface_set_target( masked );
draw_sprite( health_right, 0, 0, 0 );
surface_reset_target();
